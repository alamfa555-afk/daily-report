        ...
        <main className="flex-1 px-4 max-w-7xl mx-auto w-full space-y-6 pb-20 non-printable">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 bg-slate-900/30 backdrop-blur-xl border border-slate-800/80 rounded-2xl shadow-2xl p-6">
              ...
              {/* Form Tab Switches */}
              <div className="flex gap-2 p-1 bg-slate-950/70 border border-slate-800/70 rounded-xl mb-4">
                <button
                  type="button"
                  onClick={() => setActiveFormTab("receive")}
                  className={`cursor-pointer flex-1 py-1.5 px-3 rounded-lg text-[11px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
